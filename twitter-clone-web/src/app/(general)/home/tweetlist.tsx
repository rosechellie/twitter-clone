...
import './layout.module.css'; // Import the module CSS
...
export const Home = () => {
  ...
  const fetchTweets = async () => {
    ...
    // }
    try {
      const response = await axios.get(`${process.env.NEXT_PUBLIC_API_URL}/api/tweets/all`,
        { 
          headers: {
    ...
    <div>
      <form onSubmit={handleTweetSubmit}>
        <textarea
          ...
          style={{ width: '100%' }}
        />
        <Button type="submit" style={{float: 'right'}}>Tweet</Button>
      </form>
      <div className='tweetlistcontainer' style={{paddingTop: '40px'}}>
